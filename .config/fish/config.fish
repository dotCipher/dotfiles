...
# Jabba
set -gx JABBA_HOME /mnt/c/Users/cmoore/.jabba/
...
# Ansible Environment
set ANSIBLE_VAULT_PASSWORD_FILE ~/.ansible/.vault_pass.txt

set -gx GPG_TTY (tty)

# SDK Man
set -g SDKMAN_DIR "/home/c:moore/.sdkman"
...
# Jabba
[ -s "/mnt/c/Users/cmoore/.jabba//jabba.fish" ]; and source "/mnt/c/Users/cmoore/.jabba/jabba.fish"
